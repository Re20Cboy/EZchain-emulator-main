...
var (
	...
	FileInput           = `D:\\BC_simulate\\download_block_info\\1000000to1999999_BlockTransaction\\1000000to1999999_BlockTransaction.csv` //the raw BlockTransaction data path
)
